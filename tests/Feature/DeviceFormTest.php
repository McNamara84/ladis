...
class DeviceFormTest extends TestCase
{
    ...
    public function test_can_store_device_with_valid_data(): void
    {
        $deviceData = [
            ...
            'weight' => 45.50,
            'fiber_length' => 10.00,
            'cooling' => Device::COOLING_INTERNAL, // Intern
            'mounting' => true,
            'automation' => false,
            'max_output' => 100.5,
            'mean_output' => 75.0,
            ...
            'head' => 'Optik OS A20',
            'emission_source' => 0,
            'beam_type' => Device::BEAM_POINT, // Punktlaser
    ...
    public function test_accepts_boundary_values(): void
    {
        $deviceData = [
            ...
            'beam_type' => Device::BEAM_AREA, // Max. allowed
            'build' => Device::BUILD_MIRROR_ARM, // Max. allowed
    ...
    public function test_can_view_input_form(): void
    {
        ...
        $response->assertSee(__('Add New Laser Device'));
    }
