...
@section('content')
    <div class="container">
        ...
        <h4>Anschrift</h4>
        <address>
            <span class="fw-bold">Fachhochschule Potsdam<br>
            University of Applied Sciences</span><br>
            Kiepenheuerallee 5<br>
            14469 Potsdam<br>
            <br>
            <span class="fw-bold">Telefon:</span><a href="tel:+49 331 580-00">+49 331 580-00</a><br>
            <span class="fw-bold">Fax: </span>+49 331 580-1009<br>
            <span class="fw-bold">E-Mail: </span><a href="mailto:info@fh-potsdam.de">info@fh-potsdam.de</a><br>
            <span class="fw-bold">Webseite: </span><a href="https://www.fh-potsdam.de">www.fh-potsdam.de</a><br>
        </address>
        <h2>Zuständige Aufsichtsbehörde</h2>
        <p>
            <span class="fw-bold">Ministerium für Wissenschaft, Forschung und Kultur des Landes Brandenburg</span><br>
            Dortustr. 36<br>
            14467 Potsdam<br>
            <br>
