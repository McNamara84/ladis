...
@section('title', 'Dashboard - Laser-Projekt')
            ...
            <div class="col-12">
                <div class="bg-primary text-white rounded p-4">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h1 class="h3 mb-2">Willkommen zurück, {{ Auth::user()->name }}!</h1>
                            <p class="mb-0 opacity-75">
                                Verwalten Sie Ihre Reinigungslaser-Datenbank und Restaurierungsprojekte.
                            </p>
                        </div>
                ...
                <div class="card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="text-center text-muted py-4">
                            ...
                            <p class="mb-0">Noch keine Aktivitäten vorhanden</p>
                            <small>Starten Sie mit der Erfassung von Reinigungslasern</small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                    <span class="text-muted small">Anmeldung</span>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm bg-light">
                    <div class="card-body text-center py-5">
                        ...
                        <h3 class="h4 mb-3">Willkommen im Laser-Projekt!</h3>
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <div class="text-center p-3 bg-primary bg-opacity-10 rounded">
                        ...
                        <div class="small text-muted">Laser erfasst</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-center p-3 bg-success bg-opacity-10 rounded">
                        <div class="h2 text-success mb-1">0</div>
                        <div class="small text-muted">Projekte aktiv</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-center p-3 bg-warning bg-opacity-10 rounded">
                        <div class="h2 text-warning mb-1">0</div>
                        <div class="small text-muted">In Bearbeitung</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-center p-3 bg-info bg-opacity-10 rounded">
                        <div class="h2 text-info mb-1">{{ Auth::user()->created_at->diffForHumans() }}</div>
                        <div class="small text-muted">Mitglied seit</div>
                    </div>
                </div>
            </div>
        </div>
