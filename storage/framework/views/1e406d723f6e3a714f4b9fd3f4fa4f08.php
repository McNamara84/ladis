<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <p>Diese Datenschutzhinweise (Stand: <time datetime="<?php echo e($lastUpdated); ?>"><?php echo e($lastUpdated); ?></time>) gelten für folgende von der FH Potsdam betriebenen Seiten:</p>
        <ul>
        ...
        <p>Wir behalten uns vor, diese Datenschutzerklärung zu ändern, um sie an geänderte rechtliche Rahmenbedingungen oder bei Änderungen des Dienstes anzupassen. Die aktuelle Version wurde am <time datetime="<?php echo e($lastUpdated); ?>"><?php echo e($lastUpdated); ?></time> ist stets auf unserer Webseite verfügbar. Bitte informieren Sie sich regelmäßig über die geltenden Datenschutzbestimmungen.</p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Maya/GitHub/cleanup-laser-database/resources/views/datenschutz.blade.php ENDPATH**/ ?>