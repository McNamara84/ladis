<!doctype html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="min-vh-100">
    ...
    <div id="app" class="d-flex flex-column min-vh-100">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        ...
                        <ul class="navbar-nav me-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(url('/inputform')); ?>">
                                    Eingabemaske
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(url('/advanced_search')); ?>">
                                    Erweiterte Suche
                                </a>
                            </li>
                        </ul>
        ...
        <footer class="py-4 bg-body-secondary">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <h6 class="fw-bold"><?php echo e(config('app.name')); ?> Version <?php echo e($projectVersion); ?></h6>
                        <p class="small mb-0">
                            Datenbank zu Reinigungslasern in der Restaurierung<br>
                            Fachhochschule Potsdam - Studentisches Projekt<br>
                            <a href="<?php echo e(route('datenschutz')); ?>">Datenschutzerklärung</a>
                        </p>
                    </div>
                    <div class="col-md-4 text-md-end">
                        <p class="small mb-0">
                            LIZENZ <?php echo e(date('Y')); ?> FH Potsdam<br>
...
<?php /**PATH /Users/Maya/GitHub/cleanup-laser-database/resources/views/layouts/app.blade.php ENDPATH**/ ?>