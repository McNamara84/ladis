        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted">Melden Sie sich in Ihrem <?php echo e(config('app.name')); ?> Konto an</p>
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center mt-3">
                    <a href="<?php echo e(url('/')); ?>" class="btn btn-link text-muted text-decoration-none">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Maya/GitHub/cleanup-laser-database/resources/views/auth/login.blade.php ENDPATH**/ ?>