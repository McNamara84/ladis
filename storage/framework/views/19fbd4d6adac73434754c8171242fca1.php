<?php $__env->startSection('content'); ?>
    ...
    <div class="vh-section">
        <div class="container content hero">
            ...
            <p><span class="brand-name"><?php echo e(config('app.name')); ?></span> ist ein Informationssystem zur Dokumentation von
        ...
        <section class="row g-md-5 pb-md-5 mb-5 align-items-center">
            ...
            <div class="row gx-md-5">
                <div class="col-lg-8 mb-3">
                    ...
                    <p>
                        <a class="btn btn-outline-primary" href="<?php echo e(url('/advanced_search')); ?>">→ Recherche starten</a>
                    </p>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Maya/GitHub/cleanup-laser-database/resources/views/welcome.blade.php ENDPATH**/ ?>